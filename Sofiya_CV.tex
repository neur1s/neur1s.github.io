...
\begin{enumerate}
    \item \textbf{Zbaranska, S.}, Rajeev A., Josselyn S., Laschowski B. (2026) A Brain-Inspired Memory Mechanism for Neural Networks Based on Emotional Valence (submitted to \textit{Neural Information Processing Systems}). \\
