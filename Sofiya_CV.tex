...
\section*{Service}
\begin{itemize}
    \item[\textbf{Since 2023}] Peer reviewer for \textit{Philosophical Transactions of the Royal Society B} (1 manuscript), \textit{International Conference on Learning Representations} (2 manuscripts)
